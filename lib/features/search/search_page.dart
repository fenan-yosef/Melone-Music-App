...
class _SearchPageState extends State<SearchPage>
  ...
  Future<void> _search(String query, String type) async {
    ...
    switch (type) {
      case 'albums':
        url =
            'https://api.jamendo.com/v3.0/albums/?client_id=$clientId&format=json&search=$query';
        break;
      case 'artists':
        url =
            'https://api.jamendo.com/v3.0/artists/?client_id=$clientId&format=json&search=$query';
        break;
      case 'tracks':
        url =
            'https://api.jamendo.com/v3.0/tracks/?client_id=$clientId&format=json&search=$query';
        break;
      case 'genres':
        url =
            'https://api.jamendo.com/v3.0/tags/?client_id=$clientId&format=json&search=$query';
        break;
      default:
        url = '';
        break;
